...
from mesh_tie import core_model_1x
...
class Model(nn.Module):
    ...
    def __init__(self, params, learned_model):
        ...
        self._reciever_normalizer = normalization.Normalizer(size=5, name='reciever_normalizer')
        self._sender_normalizer = normalization.Normalizer(size=5, name='sender_normalizer')
    ...
    def _build_graph(self, inputs, is_training):
        ...
        return (core_model_1x.MultiGraph(node_features=self._node_normalizer(node_features),
                                        reciever_features=self._reciever_normalizer(reciever_features),
                                        sender_features=self._sender_normalizer(reciever_features),
                                        adj=adj))
