...
class Model(nn.Module):
    ...
    def __init__(self, params, learned_model):
        ...
        self._reciever_normalizer = normalization.Normalizer(size=2 + common.NodeType.SIZE, name='reciever_normalizer')
        self._sender_normalizer = normalization.Normalizer(size=2 + common.NodeType.SIZE, name='sender_normalizer')
