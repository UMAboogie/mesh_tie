...
from mesh_tie import core_model_absol
from mesh_tie import cloth_model_absol
from mesh_tie import cloth_eval
from mesh_tie import cfd_model_absol
from mesh_tie import cfd_eval
from mesh_tie import deform_model
...
PARAMETERS = {
    'cfd': dict(traj_num=[500,50,50], noise=0.02, gamma=1.0, field='velocity', history=False,
                size=2, batch=2, model=cfd_model_absol, evaluator=cfd_eval, loss_type='cfd'),
    'cloth': dict(traj_num=[500,50,50], noise=0.003, gamma=0.1, field='world_pos', history=True,
                  size=3, batch=1, model=cloth_model_absol, evaluator=cloth_eval, loss_type='cloth'),
...
def main(argv):
    ...
    learned_model = core_model_absol.EncodeProcessDecode(
