...
class Model(nn.Module):
    ...
    def __init__(self, params, learned_model):
        ...
        self._node_normalizer = normalization.Normalizer(size=common.NodeType.SIZE, name='node_normalizer')
        """
        ...
        """
        self._reciever_normalizer = normalization.Normalizer(size=common.NodeType.SIZE, name='reciever_normalizer')
        self._sender_normalizer = normalization.Normalizer(size=common.NodeType.SIZE, name='sender_normalizer')
    ...
    def _build_graph(self, inputs, is_training):
        ...
        reciever_features = node_features
        sender_features = node_features


        
        return (core_model_1.MultiGraph(node_features=node_features,
